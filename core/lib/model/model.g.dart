...
Image _$ImageFromJson(Map<String, dynamic> json) {
  return Image()
    ...
    ..tags = (json['tags'] as List).map((e) => _$enumDecode(_$ImageTagEnumMap, e)).toList()
...
Map<String, dynamic> _$UserToJson(User instance) =>
    <String, dynamic>{'name': instance.name, 'email': instance.email, 'innerToken': instance.innerToken};
...
Buff _$BuffFromJson(Map<String, dynamic> json) {
  return Buff()
    ...
    ..attackDelta = (json['attackDelta'] as List)?.map((e) => e as int)?.toList()
    ..extraTags = (json['extraTags'] as List)?.map((e) => e as String)?.toSet()
    ..bannedTags = (json['bannedTags'] as List)?.map((e) => e as String)?.toSet()
    ..expiration = json['expiration'] as int
    ..buffType = json['buffType'] as String
    ..stackStrength = json['stackStrength'] as int
    ..doesNotStackWith = (json['doesNotStackWith'] as List)?.map((e) => e as String)?.toList();
}
...
Triggers _$TriggersFromJson(Map<String, dynamic> json) {
  return Triggers()
    ..onInit = (json['onInit'] as List).map((e) => Trigger.fromJson(e as Map<String, dynamic>)).toList()
    ..onUnitDies = (json['onUnitDies'] as List).map((e) => UnitTrigger.fromJson(e as Map<String, dynamic>)).toList();
}
...
Trigger _$TriggerFromJson(Map<String, dynamic> json) {
  return Trigger()
    ...
    ..action = json['action'] == null ? null : Action.fromJson(json['action'] as Map<String, dynamic>);
}
...
Map<String, dynamic> _$UnitTriggerToJson(UnitTrigger instance) =>
    <String, dynamic>{'condition': instance.condition?.toJson(), 'action': instance.action?.toJson()};

Condition _$ConditionFromJson(Map<String, dynamic> json) {
  return Condition()
    ..andCondition =
        json['andCondition'] == null ? null : AndCondition.fromJson(json['andCondition'] as Map<String, dynamic>);
}
...
AndCondition _$AndConditionFromJson(Map<String, dynamic> json) {
  return AndCondition()
    ..condition1 = json['condition1'] == null ? null : Condition.fromJson(json['condition1'] as Map<String, dynamic>)
    ..condition2 = json['condition2'] == null ? null : Condition.fromJson(json['condition2'] as Map<String, dynamic>);
}

Map<String, dynamic> _$AndConditionToJson(AndCondition instance) =>
    <String, dynamic>{'condition1': instance.condition1?.toJson(), 'condition2': instance.condition2?.toJson()};
...
Action _$ActionFromJson(Map<String, dynamic> json) {
  return Action()
    ..unitAction = json['unitAction'] == null
        ? null
        : UnitCreateOrUpdateAction.fromJson(json['unitAction'] as Map<String, dynamic>)
    ..victoryCheckAction = json['victoryCheckAction'] == null
        ? null
        : VictoryCheckAction.fromJson(json['victoryCheckAction'] as Map<String, dynamic>);
}
...
VictoryCheckAction _$VictoryCheckActionFromJson(Map<String, dynamic> json) {
  return VictoryCheckAction()
    ..allTeamsEliminatedForWin = (json['allTeamsEliminatedForWin'] as List)?.map((e) => e as String)?.toList()
    ..anyOfTeamsEliminatedForWin = (json['anyOfTeamsEliminatedForWin'] as List)?.map((e) => e as String)?.toList()
    ..anyOfTeamsEliminatedForLost = (json['anyOfTeamsEliminatedForLost'] as List)?.map((e) => e as String)?.toList()
    ..allOfTeamsEliminatedForLost = (json['allOfTeamsEliminatedForLost'] as List)?.map((e) => e as String)?.toList()
    ..unitsEliminatedForLost = (json['unitsEliminatedForLost'] as List)?.map((e) => e as String)?.toList();
}

Map<String, dynamic> _$VictoryCheckActionToJson(VictoryCheckAction instance) => <String, dynamic>{
...
AiInstructionSetUnitTarget _$AiInstructionSetUnitTargetFromJson(Map<String, dynamic> json) {
  return AiInstructionSetUnitTarget()
    ..unitTaleId = json['unitTaleId'] as String
    ..actionOnTarget = _$enumDecodeNullable(_$AiActionEnumMap, json['actionOnTarget']);
}

Map<String, dynamic> _$AiInstructionSetUnitTargetToJson(AiInstructionSetUnitTarget instance) =>
    <String, dynamic>{'unitTaleId': instance.unitTaleId, 'actionOnTarget': _$AiActionEnumMap[instance.actionOnTarget]};
...
Race _$RaceFromJson(Map<String, dynamic> json) {
  return Race()
    ...
    ..name = (json['name'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(_$enumDecodeNullable(_$LangEnumMap, k), e as String));
}
...
Player _$PlayerFromJson(Map<String, dynamic> json) {
  return Player()
    ...
    ..humanPlayer =
        json['humanPlayer'] == null ? null : HumanPlayer.fromJson(json['humanPlayer'] as Map<String, dynamic>)
    ..aiGroup = json['aiGroup'] == null ? null : AiGroup.fromJson(json['aiGroup'] as Map<String, dynamic>);
}
...
HumanPlayer _$HumanPlayerFromJson(Map<String, dynamic> json) {
  return HumanPlayer()
    ...
    ..portrait = json['portrait'] == null ? null : Image.fromJson(json['portrait'] as Map<String, dynamic>);
}

Map<String, dynamic> _$HumanPlayerToJson(HumanPlayer instance) => <String, dynamic>{
      'name': instance.name,
...
AiGroup _$AiGroupFromJson(Map<String, dynamic> json) {
  return AiGroup()
    ..langName = (json['langName'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(_$enumDecodeNullable(_$LangEnumMap, k), e as String))
...
UnitCreateOrUpdateAction _$UnitCreateOrUpdateActionFromJson(Map<String, dynamic> json) {
  return UnitCreateOrUpdateAction()
    ...
    ..buffs = (json['buffs'] as List)?.map((e) => e == null ? null : Buff.fromJson(e as Map<String, dynamic>))?.toList()
    ...
    ..useAnimationName = _$enumDecodeNullable(_$AnimationNameEnumMap, json['useAnimationName'])
    ..diceNumbers = (json['diceNumbers'] as List)?.map((e) => e as int)?.toList()
    ..explain = _$enumDecodeNullable(_$ActionExplanationEnumMap, json['explain'])
    ..explainFirstValue = json['explainFirstValue'] as String;
}

Map<String, dynamic> _$UnitCreateOrUpdateActionToJson(UnitCreateOrUpdateAction instance) {
  final val = <String, dynamic>{};
  ...
  writeNotNull('useAnimationName', _$AnimationNameEnumMap[instance.useAnimationName]);
...
const _$AnimationNameEnumMap = <AnimationName, dynamic>{AnimationName.move: 'move'};
...
UnitDeleteAction _$UnitDeleteActionFromJson(Map<String, dynamic> json) {
  return UnitDeleteAction()
    ..actionId = json['actionId'] as String
    ..unitId = json['unitId'] as String
    ..animationName = _$enumDecodeNullable(_$AnimationNameEnumMap, json['animationName']);
}

Map<String, dynamic> _$UnitDeleteActionToJson(UnitDeleteAction instance) => <String, dynamic>{
...
Map<String, dynamic> _$CancelOnFieldActionToJson(CancelOnFieldAction instance) => <String, dynamic>{
      'actionId': instance.actionId,
...
UnitTypeCompiled _$UnitTypeCompiledFromJson(Map<String, dynamic> json) {
  return UnitTypeCompiled()
    ...
    ..tags = (json['tags'] as List)?.map((e) => _$enumDecodeNullable(_$UnitTypeTagEnumMap, e))?.toList()
    ..health = json['health'] as int
    ...
    ..abilities =
        json['abilities'] == null ? null : AbilitiesEnvelope.fromJson(json['abilities'] as Map<String, dynamic>)
    ..authorEmail = json['authorEmail'] as String
    ..image = json['image'] == null ? null : Image.fromJson(json['image'] as Map<String, dynamic>)
    ..icon = json['icon'] == null ? null : Image.fromJson(json['icon'] as Map<String, dynamic>)
    ..bigImage = json['bigImage'] == null ? null : Image.fromJson(json['bigImage'] as Map<String, dynamic>);
}

Map<String, dynamic> _$UnitTypeCompiledToJson(UnitTypeCompiled instance) => <String, dynamic>{
      'name': instance.name,
...
UnitTypeCreateEnvelope _$UnitTypeCreateEnvelopeFromJson(Map<String, dynamic> json) {
...
Map<String, dynamic> _$UnitTypeCreateEnvelopeToJson(UnitTypeCreateEnvelope instance) => <String, dynamic>{
      'name': instance.name,
      'race': _$RacesEnumMap[instance.race],
      'tags': instance.tags?.map((e) => _$UnitTypeTagEnumMap[e])?.toList(),
      'health': instance.health,
...
GameHeroCreateEnvelope _$GameHeroCreateEnvelopeFromJson(Map<String, dynamic> json) {
  return GameHeroCreateEnvelope()
    ..level = json['level'] as int
    ..name = json['name'] as String
    ..type = json['type'] == null ? null : UnitTypeCompiled.fromJson(json['type'] as Map<String, dynamic>)
    ..unit = json['unit'] == null ? null : UnitCreateOrUpdateAction.fromJson(json['unit'] as Map<String, dynamic>);
}

Map<String, dynamic> _$GameHeroCreateEnvelopeToJson(GameHeroCreateEnvelope instance) => <String, dynamic>{
...
FieldCreateEnvelope _$FieldCreateEnvelopeFromJson(Map<String, dynamic> json) {
  return FieldCreateEnvelope()..terrain = _$enumDecodeNullable(_$TerrainEnumMap, json['terrain']);
}

Map<String, dynamic> _$FieldCreateEnvelopeToJson(FieldCreateEnvelope instance) =>
...
World _$WorldFromJson(Map<String, dynamic> json) {
  return World()
    ...
    ..fields = (json['fields'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(k, e == null ? null : FieldCreateEnvelope.fromJson(e as Map<String, dynamic>)))
...
Tale _$TaleFromJson(Map<String, dynamic> json) {
  return Tale()
    ...
    ..langs = (json['langs'] as Map<String, dynamic>)?.map((k, e) => MapEntry(
        _$enumDecodeNullable(_$LangEnumMap, k), (e as Map<String, dynamic>)?.map((k, e) => MapEntry(k, e as String))))
    ..langName = (json['langName'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(_$enumDecodeNullable(_$LangEnumMap, k), e as String))
    ..world = json['world'] == null ? null : World.fromJson(json['world'] as Map<String, dynamic>)
    ..unitTypes = (json['unitTypes'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(k, e == null ? null : UnitType.fromJson(e as Map<String, dynamic>)))
    ..players = (json['players'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(k, e == null ? null : Player.fromJson(e as Map<String, dynamic>)))
    ..playerOnMoveIds = (json['playerOnMoveIds'] as List)?.map((e) => e as String)?.toList()
    ..units = (json['units'] as List)
        ?.map((e) => e == null ? null : UnitCreateOrUpdateAction.fromJson(e as Map<String, dynamic>))
        ?.toList();
}
...
Assets _$AssetsFromJson(Map<String, dynamic> json) {
  return Assets()
    ..images = (json['images'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(k, e == null ? null : Image.fromJson(e as Map<String, dynamic>)));
}

Map<String, dynamic> _$AssetsToJson(Assets instance) =>
    <String, dynamic>{'images': instance.images?.map((k, e) => MapEntry(k, e?.toJson()))};
...
Map<String, dynamic> _$EventToJson(Event instance) =>
    <String, dynamic>{'name': instance.name, 'triggers': instance.triggers?.map((e) => e?.toJson())?.toList()};

Dialog _$DialogFromJson(Map<String, dynamic> json) {
  return Dialog()..name = json['name'] as String;
}

Map<String, dynamic> _$DialogToJson(Dialog instance) => <String, dynamic>{'name': instance.name};

TaleCreateEnvelope _$TaleCreateEnvelopeFromJson(Map<String, dynamic> json) {
  return TaleCreateEnvelope()
    ..authorEmail = json['authorEmail'] as String
    ..tale = json['tale'] == null ? null : TaleInnerEnvelope.fromJson(json['tale'] as Map<String, dynamic>)
    ..lobby = json['lobby'] == null ? null : LobbyTale.fromJson(json['lobby'] as Map<String, dynamic>);
}

Map<String, dynamic> _$TaleCreateEnvelopeToJson(TaleCreateEnvelope instance) => <String, dynamic>{
      'authorEmail': instance.authorEmail,
...
TaleCompiled _$TaleCompiledFromJson(Map<String, dynamic> json) {
  return TaleCompiled()
    ..authorEmail = json['authorEmail'] as String
    ..tale = json['tale'] == null ? null : TaleInnerCompiled.fromJson(json['tale'] as Map<String, dynamic>)
    ..lobby = json['lobby'] == null ? null : LobbyTale.fromJson(json['lobby'] as Map<String, dynamic>);
}

Map<String, dynamic> _$TaleCompiledToJson(TaleCompiled instance) => <String, dynamic>{
      'authorEmail': instance.authorEmail,
      'tale': instance.tale?.toJson(),
      'lobby': instance.lobby?.toJson()
    };
...
TaleInnerEnvelope _$TaleInnerEnvelopeFromJson(Map<String, dynamic> json) {
  return TaleInnerEnvelope()
    ...
    ..world = json['world'] == null ? null : World.fromJson(json['world'] as Map<String, dynamic>)
    ..aiPlayers = (json['aiPlayers'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(k, e == null ? null : Player.fromJson(e as Map<String, dynamic>)))
    ..events = (json['events'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(k, e == null ? null : Event.fromJson(e as Map<String, dynamic>)))
    ..dialogs = (json['dialogs'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(k, e == null ? null : Dialog.fromJson(e as Map<String, dynamic>)))
    ..units = (json['units'] as List)
        ?.map((e) => e == null ? null : UnitCreateOrUpdateAction.fromJson(e as Map<String, dynamic>))
        ?.toList()
...
Map<String, dynamic> _$TaleInnerEnvelopeToJson(TaleInnerEnvelope instance) => <String, dynamic>{
      'name': instance.name,
      'langName': instance.langName?.map((k, e) => MapEntry(_$LangEnumMap[k], e)),
      'langs': instance.langs?.map((k, e) => MapEntry(_$LangEnumMap[k], e)),
...
TaleInnerCompiled _$TaleInnerCompiledFromJson(Map<String, dynamic> json) {
  return TaleInnerCompiled()
    ...
    ..images = (json['images'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(k, e == null ? null : Image.fromJson(e as Map<String, dynamic>)))
    ..unitTypes = (json['unitTypes'] as Map<String, dynamic>)
        ?.map((k, e) => MapEntry(k, e == null ? null : UnitTypeCompiled.fromJson(e as Map<String, dynamic>)))
    ..triggers = json['triggers'] == null ? null : Triggers.fromJson(json['triggers'] as Map<String, dynamic>);
}

Map<String, dynamic> _$TaleInnerCompiledToJson(TaleInnerCompiled instance) => <String, dynamic>{
      'name': instance.name,
      'langs': instance.langs?.map((k, e) => MapEntry(_$LangEnumMap[k], e)),
      'langName': instance.langName?.map((k, e) => MapEntry(_$LangEnumMap[k], e)),
      'taleVersion': instance.taleVersion,
...
Map<String, dynamic> _$LobbyTaleToJson(LobbyTale instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name?.map((k, e) => MapEntry(_$LangEnumMap[k], e)),
      'description': instance.description?.map((k, e) => MapEntry(_$LangEnumMap[k], e)),
      'image': instance.image?.toJson()
    };
...
OpenedLobby _$OpenedLobbyFromJson(Map<String, dynamic> json) {
  return OpenedLobby()
    ...
    ..players =
        (json['players'] as List)?.map((e) => e == null ? null : Player.fromJson(e as Map<String, dynamic>))?.toList();
}

Map<String, dynamic> _$OpenedLobbyToJson(OpenedLobby instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name?.map((k, e) => MapEntry(_$LangEnumMap[k], e)),
      'description': instance.description?.map((k, e) => MapEntry(_$LangEnumMap[k], e)),
      'image': instance.image?.toJson(),
...
Map<String, dynamic> _$ToClientMessageToJson(ToClientMessage instance) =>
    <String, dynamic>{'message': _$OnClientActionEnumMap[instance.message], 'content': instance.content};
...
SetNavigationState _$SetNavigationStateFromJson(Map<String, dynamic> json) {
  return SetNavigationState()
    ..newState = _$enumDecodeNullable(_$GameNavigationStateEnumMap, json['newState'])
    ..destroyCurrentTale = json['destroyCurrentTale'] as bool;
}

Map<String, dynamic> _$SetNavigationStateToJson(SetNavigationState instance) => <String, dynamic>{
...
RefreshLobbyList _$RefreshLobbyListFromJson(Map<String, dynamic> json) {
  return RefreshLobbyList()
    ..lobbies = (json['lobbies'] as List)
        ?.map((e) => e == null ? null : OpenedLobby.fromJson(e as Map<String, dynamic>))
        ?.toList();
}

Map<String, dynamic> _$RefreshLobbyListToJson(RefreshLobbyList instance) =>
    <String, dynamic>{'lobbies': instance.lobbies?.map((e) => e?.toJson())?.toList()};

GetGamesToCreate _$GetGamesToCreateFromJson(Map<String, dynamic> json) {
  return GetGamesToCreate()
    ..games =
        (json['games'] as List)?.map((e) => e == null ? null : LobbyTale.fromJson(e as Map<String, dynamic>))?.toList();
}
...
SetCurrentUser _$SetCurrentUserFromJson(Map<String, dynamic> json) {
  return SetCurrentUser()..user = json['user'] == null ? null : User.fromJson(json['user'] as Map<String, dynamic>);
}
...
OpenedLobbyData _$OpenedLobbyDataFromJson(Map<String, dynamic> json) {
  return OpenedLobbyData()
    ..lobby = json['lobby'] == null ? null : OpenedLobby.fromJson(json['lobby'] as Map<String, dynamic>);
}
...
TaleData _$TaleDataFromJson(Map<String, dynamic> json) {
  return TaleData()
    ..tale = json['tale'] == null ? null : Tale.fromJson(json['tale'] as Map<String, dynamic>)
    ..assets = json['assets'] == null ? null : Assets.fromJson(json['assets'] as Map<String, dynamic>)
    ..playerIdOnThisClientMachine = json['playerIdOnThisClientMachine'] as String;
}
...
TaleUpdate _$TaleUpdateFromJson(Map<String, dynamic> json) {
  return TaleUpdate()
    ..actions = (json['actions'] as List)
        ?.map((e) => e == null ? null : UnitCreateOrUpdateAction.fromJson(e as Map<String, dynamic>))
        ?.toList()
    ..playerOnMoveIds = (json['playerOnMoveIds'] as List)?.map((e) => e as String)
    ..newUnitTypesToTale = (json['newUnitTypesToTale'] as List)
        ?.map((e) => e == null ? null : UnitType.fromJson(e as Map<String, dynamic>))
        ?.toList()
    ..newAssetsToTale =
        json['newAssetsToTale'] == null ? null : Assets.fromJson(json['newAssetsToTale'] as Map<String, dynamic>)
    ..newPlayersToTale = (json['newPlayersToTale'] as List)
        ?.map((e) => e == null ? null : Player.fromJson(e as Map<String, dynamic>))
        ?.toList();
}
...
Map<String, dynamic> _$TaleUpdateToJson(TaleUpdate instance) {
  ...
  writeNotNull('newUnitTypesToTale', instance.newUnitTypesToTale?.map((e) => e?.toJson())?.toList());
  writeNotNull('newAssetsToTale', instance.newAssetsToTale?.toJson());
  writeNotNull('newPlayersToTale', instance.newPlayersToTale?.map((e) => e?.toJson())?.toList());
  return val;
}
...
UnitDelete _$UnitDeleteFromJson(Map<String, dynamic> json) {
  return UnitDelete()
    ..actions = (json['actions'] as List)
        ?.map((e) => e == null ? null : UnitDeleteAction.fromJson(e as Map<String, dynamic>))
        ?.toList();
}

Map<String, dynamic> _$UnitDeleteToJson(UnitDelete instance) =>
    <String, dynamic>{'actions': instance.actions?.map((e) => e?.toJson())?.toList()};

CancelOnField _$CancelOnFieldFromJson(Map<String, dynamic> json) {
  return CancelOnField()
    ..actions = (json['actions'] as List)
        ?.map((e) => e == null ? null : CancelOnFieldAction.fromJson(e as Map<String, dynamic>))
        ?.toList();
}
...
IntentionUpdate _$IntentionUpdateFromJson(Map<String, dynamic> json) {
  return IntentionUpdate()
    ...
    ..trackFieldsId = (json['trackFieldsId'] as List)?.map((e) => e as String)?.toList();
}

Map<String, dynamic> _$IntentionUpdateToJson(IntentionUpdate instance) =>
    <String, dynamic>{'playerId': instance.playerId, 'trackFieldsId': instance.trackFieldsId};
...
Map<String, dynamic> _$BanterToJson(Banter instance) =>
    <String, dynamic>{'milliseconds': instance.milliseconds, 'image': instance.image?.toJson(), 'text': instance.text};
...
Map<String, dynamic> _$ToGameServerMessageToJson(ToGameServerMessage instance) =>
    <String, dynamic>{'message': _$OnServerActionEnumMap[instance.message], 'content': instance.content};
...
GoToState _$GoToStateFromJson(Map<String, dynamic> json) {
  return GoToState()..newState = _$enumDecodeNullable(_$GameNavigationStateEnumMap, json['newState']);
}

Map<String, dynamic> _$GoToStateToJson(GoToState instance) =>
    <String, dynamic>{'newState': _$GameNavigationStateEnumMap[instance.newState]};

InitMessage _$InitMessageFromJson(Map<String, dynamic> json) {
  return InitMessage()..innerToken = json['innerToken'] as String;
}

Map<String, dynamic> _$InitMessageToJson(InitMessage instance) => <String, dynamic>{'innerToken': instance.innerToken};
...
Map<String, dynamic> _$EnterLobbyToJson(EnterLobby instance) => <String, dynamic>{'lobbyId': instance.lobbyId};

EnterGame _$EnterGameFromJson(Map<String, dynamic> json) {
  return EnterGame()..lobbyId = json['lobbyId'] as String;
}

Map<String, dynamic> _$EnterGameToJson(EnterGame instance) => <String, dynamic>{'lobbyId': instance.lobbyId};

UnitTrackAction _$UnitTrackActionFromJson(Map<String, dynamic> json) {
  return UnitTrackAction()
    ..abilityName = _$enumDecodeNullable(_$AbilityNameEnumMap, json['abilityName'])
    ..unitId = json['unitId'] as String
    ..track = (json['track'] as List)?.map((e) => e as String)?.toList()
    ..actionId = json['actionId'] as String;
}

Map<String, dynamic> _$UnitTrackActionToJson(UnitTrackAction instance) => <String, dynamic>{
...
PlayerGameIntention _$PlayerGameIntentionFromJson(Map<String, dynamic> json) {
  return PlayerGameIntention()..fieldsId = (json['fieldsId'] as List)?.map((e) => e as String)?.toList();
}

Map<String, dynamic> _$PlayerGameIntentionToJson(PlayerGameIntention instance) =>
    <String, dynamic>{'fieldsId': instance.fieldsId};

ControlsAction _$ControlsActionFromJson(Map<String, dynamic> json) {
  return ControlsAction()..actionName = _$enumDecodeNullable(_$ControlsActionNameEnumMap, json['actionName']);
}

Map<String, dynamic> _$ControlsActionToJson(ControlsAction instance) =>
    <String, dynamic>{'actionName': _$ControlsActionNameEnumMap[instance.actionName]};

const _$ControlsActionNameEnumMap = <ControlsActionName, dynamic>{ControlsActionName.endOfTurn: 'endOfTurn'};

ToHeroServerMessage _$ToHeroServerMessageFromJson(Map<String, dynamic> json) {
  return ToHeroServerMessage()
    ..message = _$enumDecodeNullable(_$OnHeroServerActionEnumMap, json['message'])
    ..content = json['content'] as String;
}

Map<String, dynamic> _$ToHeroServerMessageToJson(ToHeroServerMessage instance) =>
    <String, dynamic>{'message': _$OnHeroServerActionEnumMap[instance.message], 'content': instance.content};
...
GetHeroesOfPlayer _$GetHeroesOfPlayerFromJson(Map<String, dynamic> json) {
  return GetHeroesOfPlayer()
    ...
    ..responseHeroes = (json['responseHeroes'] as List)
        ?.map((e) => e == null ? null : GameHeroCreateEnvelope.fromJson(e as Map<String, dynamic>))
        ?.toList();
}

Map<String, dynamic> _$GetHeroesOfPlayerToJson(GetHeroesOfPlayer instance) => <String, dynamic>{
      'requestPlayerEmail': instance.requestPlayerEmail,
      'responseHeroes': instance.responseHeroes?.map((e) => e?.toJson())?.toList()
    };
...
Map<String, dynamic> _$ToAiServerMessageToJson(ToAiServerMessage instance) =>
    <String, dynamic>{'message': _$OnAiServerActionEnumMap[instance.message], 'content': instance.content};
...
GetNextMoveByState _$GetNextMoveByStateFromJson(Map<String, dynamic> json) {
  return GetNextMoveByState()
    ..responseAction =
        json['responseAction'] == null ? null : UnitTrackAction.fromJson(json['responseAction'] as Map<String, dynamic>)
    ..requestData = json['requestData'] == null ? null : Tale.fromJson(json['requestData'] as Map<String, dynamic>)
    ..requestEngine = _$enumDecodeNullable(_$AiEngineEnumMap, json['requestEngine'])
    ..idOfAiPlayerOnMove = json['idOfAiPlayerOnMove'] as String;
}

Map<String, dynamic> _$GetNextMoveByStateToJson(GetNextMoveByState instance) => <String, dynamic>{
...
GetNextMoveByUpdate _$GetNextMoveByUpdateFromJson(Map<String, dynamic> json) {
  return GetNextMoveByUpdate()
    ...
    ..requestUpdateData = json['requestUpdateData'] == null
        ? null
        : TaleUpdate.fromJson(json['requestUpdateData'] as Map<String, dynamic>);
}

Map<String, dynamic> _$GetNextMoveByUpdateToJson(GetNextMoveByUpdate instance) => <String, dynamic>{
      'responseAction': instance.responseAction?.toJson(),
...
ToUserServerMessage _$ToUserServerMessageFromJson(Map<String, dynamic> json) {
  return ToUserServerMessage()
    ..message = _$enumDecodeNullable(_$OnUserServerActionEnumMap, json['message'])
    ..content = json['content'] as String;
}

Map<String, dynamic> _$ToUserServerMessageToJson(ToUserServerMessage instance) =>
    <String, dynamic>{'message': _$OnUserServerActionEnumMap[instance.message], 'content': instance.content};
...
Map<String, dynamic> _$GetUserByInnerTokenToJson(GetUserByInnerToken instance) =>
    <String, dynamic>{'user': instance.user?.toJson(), 'innerToken': instance.innerToken};

AbilitiesEnvelope _$AbilitiesEnvelopeFromJson(Map<String, dynamic> json) {
  return AbilitiesEnvelope()
    ..move = json['move'] == null ? null : MoveAbilityEnvelope.fromJson(json['move'] as Map<String, dynamic>)
    ..attack = json['attack'] == null ? null : AttackAbilityEnvelope.fromJson(json['attack'] as Map<String, dynamic>);
}

Map<String, dynamic> _$AbilitiesEnvelopeToJson(AbilitiesEnvelope instance) =>
    <String, dynamic>{'move': instance.move?.toJson(), 'attack': instance.attack?.toJson()};
...
Map<String, dynamic> _$MoveAbilityEnvelopeToJson(MoveAbilityEnvelope instance) =>
    <String, dynamic>{'steps': instance.steps};

AttackAbilityEnvelope _$AttackAbilityEnvelopeFromJson(Map<String, dynamic> json) {
  return AttackAbilityEnvelope()
    ..steps = json['steps'] as String
    ..attack = json['attack'] as String;
}

Map<String, dynamic> _$AttackAbilityEnvelopeToJson(AttackAbilityEnvelope instance) =>
